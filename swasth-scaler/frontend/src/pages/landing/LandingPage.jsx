      ...
      <div id="about" style={{ padding: '8rem 4%', background: '#ffffff', position: 'relative' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(300px, 100%), 1fr))', gap: '2rem' }}>
            {[
              { src: pushkarAvatar, name: 'Pushkar Kulkarni', role: 'Team Lead and Main Coder', bio: 'Architecting the scalable backend of Swasthya Setu, Pushkar leads the core development team, building the robust and secure infrastructure.', quote: `"Building systems that work without internet in remote villages is a rewarding challenge."`, grad: 'linear-gradient(135deg, #112822 0%, #0a1713 100%)' },
              { src: jayantAvatar, name: 'Jayant Saxena', role: 'Frontend and UI/UX Dev', bio: 'Driven by a vision to create intuitive user experiences, Jayant leads the frontend architecture and aesthetic design.', quote: `"Designing for someone who has never used a smartphone before completely changed my perspective."`, grad: 'linear-gradient(135deg, #112822 0%, #0a1713 100%)' },
              { src: vaibhavAvatar, name: 'Vaibhav Mishra', role: 'ASHA Operations Lead', bio: 'Specializing in community outreach, Vaibhav champions the enablement of ASHA workers and manages direct field operations.', quote: `"Every feature we ship has a real ASHA worker's workflow behind it."`, grad: 'linear-gradient(135deg, #112822 0%, #0a1713 100%)' },
