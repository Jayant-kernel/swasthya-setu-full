...
export const GUEST_TRIAGE_RECORDS = [
  // ── Miraj ──────────────────────────────────────────────────────────────────
  {
    id: 'demo-001', patient_id: 'p-001',
    patient_name: 'Meera Shinde', age: 28, gender: 'Female',
    district: 'Sangli', village: 'Miraj',
    severity: 'red',
  ...
  {
    id: 'demo-002', patient_id: 'p-002',
    patient_name: 'Raju Pawar', age: 45, gender: 'Male',
    district: 'Sangli', village: 'Miraj',
    severity: 'yellow',
  ...
  // ── Kavathe Mahankal ───────────────────────────────────────────────────────
  {
    id: 'demo-003', patient_id: 'p-003',
    patient_name: 'Sunita Kamble', age: 32, gender: 'Female',
    district: 'Sangli', village: 'Kavathe Mahankal',
    severity: 'yellow',
  ...
  {
    id: 'demo-004', patient_id: 'p-004',
    patient_name: 'Anita More', age: 24, gender: 'Female',
    district: 'Sangli', village: 'Kavathe Mahankal',
    severity: 'yellow',
  ...
  // ── Jat ────────────────────────────────────────────────────────────────────
  {
    id: 'demo-005', patient_id: 'p-005',
    patient_name: 'Kishore Jadhav', age: 58, gender: 'Male',
    district: 'Sangli', village: 'Jat',
    severity: 'yellow',
  ...
  {
    id: 'demo-006', patient_id: 'p-006',
    patient_name: 'Lakshmi Bhosale', age: 9, gender: 'Female',
    district: 'Sangli', village: 'Jat',
    severity: 'red',
  ...
  // ── Atpadi ─────────────────────────────────────────────────────────────────
  {
    id: 'demo-007', patient_id: 'p-007',
    patient_name: 'Prakash Mane', age: 67, gender: 'Male',
    district: 'Sangli', village: 'Atpadi',
    severity: 'green',
  ...
  {
    id: 'demo-008', patient_id: 'p-008',
    patient_name: 'Kavya Patil', age: 19, gender: 'Female',
    district: 'Sangli', village: 'Atpadi',
    severity: 'green',
  ...
  // ── Khanapur (Vita) ────────────────────────────────────────────────────────
  {
    id: 'demo-009', patient_id: 'p-009',
    patient_name: 'Ramesh Kulkarni', age: 41, gender: 'Male',
    district: 'Sangli', village: 'Khanapur (Vita)',
    severity: 'yellow',
  ...
  // ── Kadegaon ───────────────────────────────────────────────────────────────
  {
    ...
    district: 'Sangli', village: 'Kadegaon',
    severity: 'red',
  ...
  // ── Palus ──────────────────────────────────────────────────────────────────
  {
    id: 'demo-013', patient_id: 'p-013',
    patient_name: 'Vijay Jagtap', age: 53, gender: 'Male',
    district: 'Sangli', village: 'Palus',
    severity: 'yellow',
  ...
  // ── Tasgaon ────────────────────────────────────────────────────────────────
  {
    ...
    district: 'Sangli', village: 'Tasgaon',
    severity: 'yellow',
  ...
  // ── Walwa (Islampur) ───────────────────────────────────────────────────────
  {
    ...
    district: 'Sangli', village: 'Walwa (Islampur)',
    severity: 'red',
  ...
  // ── Shirala ────────────────────────────────────────────────────────────────
  {
    ...
    district: 'Sangli', village: 'Shirala',
    severity: 'yellow',
  ...
  {
    id: 'demo-020', patient_id: 'p-020',
    patient_name: 'Rekha Mane', age: 33, gender: 'Female',
    district: 'Sangli', village: 'Shirala',
    severity: 'red',
